...
const OrderCreationLogsScreen = ({ navigation }) => {
    ...
    const loadLogs = async () => {
        try {
            ...
            const response = await api.get('/logs/order-creation', { params });
        ...
        <View style={styles.logCard}>
            ...
            <View style={styles.cardBody}>
                <View style={styles.infoRow}>
                    ...
                    <Text style={styles.infoValue}>{item.items_count}</Text>
                </View>
                <View style={styles.infoRow}>
                    <Text style={styles.infoLabel}>👤 Creado por:</Text>
                    <Text style={styles.infoValue}>{item.created_by_name} ({item.created_by_role})</Text>
                </View>
                <View style={styles.infoRow}>
...
export default OrderCreationLogsScreen;
